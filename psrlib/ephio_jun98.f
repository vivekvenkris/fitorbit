c     RENAMED ephio_jun98.f and replaced from Australia APR 2000 CAJ
...
!      write(fracbit,'(0p,d23.16,1p)') frac
      write(fracbit,'(0p,f23.20,1p)') frac
      s(length(s)+1:) = fracbit(3:19) ! decimal point and all digits
      return
      end
