...
C
C ****************************************************************
      SUBROUTINE FOLD ( DAT, ND, P, SCALE, PROF, N )
C ****************************************************************
C
C FOLDS THE ARRAY DAT(ND) AT PERIOD P, PRODUCING A PROFILE OF
...
C IF THE PERIOD IS LESS THAN OR EQUAL TO ZERO N IS RETURNED AS ZERO.
C
      DIMENSION DAT(*),PROF(*)
