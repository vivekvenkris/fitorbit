...
c - modified :-) by adding EPS1 and EPS2 jul2015 CAJ

       integer NUM_KEYS
       parameter (NUM_KEYS = 114)
       ...
       integer EPH_EPS_1
       parameter (EPH_EPS_1 = 113)
       integer EPH_EPS_2
       parameter (EPH_EPS_2 = 114)
       ...
       data parmNames(113) /'EPS1'/
       data parmNames(114) /'EPS2'/
       ...
       data parmTypes(113) /1/
       data parmTypes(114) /1/
...
c       data parmError(5) /.false./   changed for JBO 1st dec 2000 caj
       ...
       data parmError(113) /.true./
       data parmError(114) /.true./
