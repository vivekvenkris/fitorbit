...
C
              IPBUF(IUPTR) = OL_RDLIN(PRMPT, LPRMT, IFAIL)

            ELSE
C
C Batch or obey file; read the next input line using the generic routine.
C
